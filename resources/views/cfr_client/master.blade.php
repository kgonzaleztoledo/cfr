      ...
      <div class="main_container">
        ...
        <footer>
          <div class="pull-right">
           Derechos Reservados por Kenneth Andoni Gonzalez Toledo 
           <?php echo date('Y')?> <a href="">WISP CONTROL DE COBROS</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
...
<script src="https://cdn.datatables.net/1.10.19/js/dataTables.bootstrap4.min.js"></script>
    <script>
      ...
      var httpglobal="http://localhost:8000";
      ...
      function carga (){
         ...
         function edit(btn){
              ...
              var route = httpglobal+"/cfr_clients/"+btn.value+"/edit";
          ...
          var contato = $("#contrato").val();
          var route = httpglobal+"/cfr_clients/"+id+"";
          var token = $("#token").val();
