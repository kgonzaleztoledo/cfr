      ...
      <div class="main_container">
        ...
        <footer>
          <div class="pull-right">
           Derechos Reservados por Kenneth Andoni Gonzalez Toledo <?php echo date('Y')?> <a href="">WISP CONTROL DE COBROS</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
...
<script src="https://cdn.datatables.net/1.10.19/js/dataTables.bootstrap4.min.js"></script>
    <script>
      ...
      function carga (){
           ...
           $('#departmentview').DataTable({
        
            "orderCellsTop": true,
          "ServerSide": true,
          "retrieve": true,
          "ajax": "{{ url('api/departments') }}",
          ...
          "language": {
            ...
            function show(btn){
              ...
              var routeshow = "http://localhost:8000/departments/"+btn.value+"";
         ...
         function edit(btn){
              ...
              var route = "http://localhost:8000/departments/"+btn.value+"/edit";
          ...
          var route = "http://localhost:8000/departments/"+id+"";
          var token = $("#token").val();
